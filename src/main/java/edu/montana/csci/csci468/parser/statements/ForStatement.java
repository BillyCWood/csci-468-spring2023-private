...
public class ForStatement extends Statement {
    ...
    public void compile(ByteCodeGenerator code) {
        ...
        //check cast
        String loopVariableType = ByteCodeGenerator.internalNameFor(getComponentType().getJavaType());
        code.addTypeInstruction(Opcodes.CHECKCAST, loopVariableType);
        ...
        }else{code.addVarInstruction(Opcodes.ASTORE, varSlot);}


        for(Statement statement : getBody()){statement.compile(code);}
